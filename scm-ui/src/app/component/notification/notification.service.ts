...
import { SHEELU_NOTIFICATION_DATA } from './notification.token';
...
export class NotificationService {
  ...
  constructor(private _injector: Injector,
              ...
              @Inject(SHEELU_NOTIFICATION_DATA) public config: NotificationInterface) {
  ...
  open(message?: string, title?: string, config?: NotificationInterface, type: string = '') {
    ...
    // todo message As before is not recreating
